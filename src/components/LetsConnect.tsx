...
const LetsConnect = () => {
  ...
  return (
    <div className='p-20 flex items-center justify-center text-center min-h-[110vh] relative'>
        <div className='w-[90vw] lg:w-[80vw]  lg:h-[70vh]  rounded-xl flex flex-col items-center justify-center relative'>
          <div className='lg:h-[75vh] h-[85vh] max-h-[40rem] w-[90vw] lg:w-[80vw] absolute bg-black footer z-30 left-1/2 -translate-x-1/2 rounded-xs' />
